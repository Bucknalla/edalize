...
class VivadoHLS(Edatool):
    ...
    def get_version(self):
        ...
        version = "unknown"
        try:
            vivado_text = subprocess.Popen(["vivado_hls", "-version"], stdout=subprocess.PIPE, env=os.environ).communicate()[0]
            ...
            logger.warning("Unable to recognize Vivado HLS version")
